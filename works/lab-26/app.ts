...
import { canQuestion } from "./middlewares/rbac";
...
// Parse multipart form-data before csurf so `_csrf` can be read on upload forms.
...
app.get("/questions", isAuth, canQuestion, async (req: Request, res: Response) => {
